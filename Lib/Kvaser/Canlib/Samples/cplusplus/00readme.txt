...
=====================
Canlib_class.cpp and canlib_class.h represent the canlib in a object oriented way. 

Open the file test.dsw in Visual Studio 6.0 and press F7 to build a simple program that sends 100 can messages. 
