...
public:
	...
	void GetBodyFrame(SE3& bodyFrame) const;
	//void GetBodyFrame(double s, SE3& bishopFrame);
	//void GetBodyFrame(const std::vector<double>& s, std::vector<SE3>& bishopFrame);

	
	double GetInnerTubeRotation(double s) const;
	double GetInnerTubeRotation() const;	
...
private:
	...
	void findNearestGridPoint(double s, int* beginIdx, double* fracFromBegin) const;
